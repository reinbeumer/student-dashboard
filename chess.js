			...
			if (!R && (G || A < 3 || g) || (1 + R & z ^ c) > 9 && G | A > 2) {
				...
				for (E = n = G | I[T - a] - 7 ? o & z : 6 ^ c; E; E = !E && !d && !(g = T, D = T < O ? g - 3 : g + 2, I[D] < z | I[D + O - T] | I[T += T - O])) {
					...
					if (S > h || 1 < S & S == h && L > 2 | d) {
						...
						if (!(h || S - 1 | B - O | T - b | L < -1e4)) return W(y = E), c && setTimeout('X(8,0,y,2),X(8,0,y,1)', 75);
...
function W() {
	i = '<table>';
	for (u = 18; u < 98; document.body.innerHTML = i += ++u % x - 9 ? '<th width=60 height=60 onclick=\'I[b=' + u + ']&8?W():X(0,0,y,1)\'style=\'font-size:50px\'bgcolor=#' + (u - B ? u * .9 & 1 || 9 : 'd') + '0f0e0>&#' + (I[u] & 15 ? 9808 + l[67 + (I[u] & 15)] : 160) + ';' : u++ && '<tr>') B = b;
}
